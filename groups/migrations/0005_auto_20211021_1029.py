# Generated by Django 3.0 on 2021-10-21 10:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('groups', '0004_auto_20211021_1015'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='investor',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='investor_related', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='student',
            name='user',
